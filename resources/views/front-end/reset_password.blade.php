...
@section('main-content')
    <div class="container-fluid inner-banner">
        ...
        <div class="container">
            <div class="row"><h1>Reset Password</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12 login-page">
                    <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12"><h3>Reset your Password</h3></div>
                    ...
                    <form method="post" action="{{ url('/password/reset') }}" class="input-group">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="token" value="{{ $token }}">
                        <div class="col-sm-12 col-xs-12 col-md-12">
                            <input type="email" name="email" value="{{old('email')}}"  placeholder="Enter Your Email" autofocus>
                        </div>
                        <div class="col-sm-12 col-xs-12 col-md-12">
