            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12 login-page">
                    ...
                    <form action="{{ route('front_register')}}" class="input-group" method="post">
                        ...
                        <div class="col-sm-12 col-xs-12 col-md-12">
                            <input name="phone_no" type="number" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" placeholder="Enter Your Phone Number" value="{{ old('phone_no') }}">
                        </div>
